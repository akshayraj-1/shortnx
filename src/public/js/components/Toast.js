class Toast {
    ...
    constructor() {
        ...
        this.#toast.className = "relative mx-auto w-full md:w-fit px-4 md:px-6 py-2.5 text-sm sm:text-base bg-colorSurface rounded-lg shadow-xl shadow-toastShadow toast-info";
